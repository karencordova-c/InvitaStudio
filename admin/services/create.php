...
<head>
    ...
    <title><?= $appName ?> | Nuevo servicio</title>
...
<body class="admin-body" data-page="admin-services-create">
    <a class="skip-link" href="#admin-content">Saltar a crear servicio</a>
    ...
    <div class="admin-shell" data-admin-shell>
        ...
        <div class="admin-main">
            <header class="admin-topbar">
                <div class="admin-topbar__left">
                    ...
                    <div class="admin-topbar__copy">
                        <p class="admin-breadcrumb">Panel / Servicios / Nuevo</p>
                        <h1>Registrar servicio</h1>
                        <p class="admin-topbar__meta">Captura la informacion base que se mostrara en el catalogo publico.</p>
                    </div>
                </div>
            ...
            >
                <section class="admin-panel admin-panel--hero">
                    <div class="admin-section-heading">
                        ...
                        <h2>Captura simple y demostrable</h2>
                        <p class="lead">
                            Usa nombres claros, precio base, formato de entrega y tiempo estimado para mantener
                            el catalogo escolar ordenado y listo para demostracion.
                        </p>
                    </div>
                </section>
                    ...
                    <section class="admin-panel">
                        ...
                        <form class="admin-service-form" data-admin-service-form novalidate>
                            <div class="form-field" data-field-container="nombre">
                                ...
                                <input id="service-name" name="nombre" type="text" maxlength="150" placeholder="Ej. Invitacion digital basica" required>
                            ...
                            <div class="form-field" data-field-container="categoria">
                                ...
                                <input id="service-category" name="categoria" type="text" maxlength="100" list="service-category-list" placeholder="Ej. Boda" required>
                            ...
                            <div class="form-field" data-field-container="precio">
                                ...
                                <input id="service-price" name="precio" type="number" min="0" step="0.01" placeholder="0.00" required>
                            ...
                            <div class="form-field" data-field-container="tiempo_entrega">
                                ...
                                <input id="service-time" name="tiempo_entrega" type="text" maxlength="100" placeholder="Ej. 2 a 3 dias habiles" required>
                            ...
                            <div class="form-field form-field--full" data-field-container="descripcion">
                                ...
                                <textarea id="service-description" name="descripcion" rows="5" maxlength="1000" placeholder="Describe el alcance general del servicio." required></textarea>
                            ...
                            <div class="form-field form-field--full" data-field-container="imagen_referencia">
                                ...
                                <input id="service-image" name="imagen_referencia" type="text" maxlength="255" placeholder="Ej. assets/img/servicios/boda.jpg o https://sitio.com/imagen.jpg">
                                <p class="field-note">Puedes dejarlo vacio y el sistema mostrara un placeholder visual.</p>
                                <p class="field-error" data-error-for="imagen_referencia" aria-live="polite"></p>
                            </div>

                            <div class="admin-actions-row">
                                <button class="button button-primary" type="submit" data-service-submit-button data-default-label="Guardar servicio" data-loading-label="Guardando servicio...">
                                    Guardar servicio
                                </button>
                    ...
                    <aside class="admin-panel admin-service-preview" data-service-preview>
                        <div class="admin-panel__header">
                            <div>
                                ...
                                <h2>Como se vera en catalogo</h2>
                            </div>
                            <span class="chip" data-service-preview-status>Activo</span>
                        </div>
                        ...
                        <div class="admin-service-preview__copy">
                            <h3 data-service-preview-name>Nuevo servicio</h3>
                            <p class="admin-service-preview__price" data-service-preview-price>$0.00 MXN</p>
                            <p data-service-preview-description>La descripcion aparecera aqui conforme completes el formulario.</p>
                        </div>
            ...
            <footer class="admin-footer">
                <p>InvitaStudio registro de servicios.</p>
